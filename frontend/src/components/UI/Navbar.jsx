...
export function Navbar() {
    ...
    //useParams from router to check whether we are on login/signup page and render searchbar conditionally?
    //const params = useParams()
    //... className={`params.signup || params.signup ? 'hiddenClass' (or perhaps inline style or classes.hiddenDesktop) : ''`}
        ...
        <>
            ...
            <Box pb={120}>
                <Header height={60} px="md">
                    {/*use flex: 0 0 auto for outside elems, flex: 1 1 auto for central one*/}
                    <Group position="apart" sx={{height: '100%'}}>
                        {/*Split image to icon and text, then hide text when screen size is small 😩😩🥵*/}

                        <Anchor href="/" >
                            {/*<Image height={55} src={logo} alt={"logoBrand"} />*/}
                            <BooklyLogo />
                        </Anchor>
